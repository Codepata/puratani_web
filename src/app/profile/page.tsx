    ...
    <div className="bg-background">
      <div className="container py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col items-center gap-6 mb-12 text-center md:flex-row md:text-left md:gap-8">
            ...
            <div className="flex flex-col w-full sm:w-auto sm:flex-row gap-2 mt-4 md:mt-0">
